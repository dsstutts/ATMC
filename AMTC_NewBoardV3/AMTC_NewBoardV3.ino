...
#define MAX31856_CS4 31
#define MAX31856_CS5 32
#define MAX31856_CS6 33
#define MAX31856_CS7 34
#define MAX31856_CS8 35
#define MAX31856_CS9 36
#define MAX31856_CS10 37
#define MAX31856_CS11 38
#define MAX31856_CS12 39
...
int CSs[] = {MAX31856_CS1,MAX31856_CS2,MAX31856_CS3,MAX31856_CS4,MAX31856_CS5,MAX31856_CS6,MAX31856_CS7,MAX31856_CS8,MAX31856_CS9,MAX31856_CS10,MAX31856_CS11,MAX31856_CS12};
int CSs2[] = {};
...
unsigned int Interval = 7;//default Interval
...
dataString += ttime + comma + temp1 + comma + temp2 + comma + temp3 + comma + temp4 \
+ comma + temp5 + comma + temp6 + comma + temp7 + comma + temp8 + comma + temp9 + comma \
+ temp10 + comma + temp11 + comma + temp12;
...
void setup()
{
  ...
  delay(100);
  SPI.setClockDivider(SPI_CLOCK_DIV128);//Reset to 7.8 MHz and Mode 3 for MAX31856
...
{    
  ...
  if (readTemp)
  {
    ...
    temp7 = ReadTemperature(CSs[6]);
    temp8 = ReadTemperature(CSs[7]);
    temp9 = ReadTemperature(CSs[8]);
    temp10 = ReadTemperature(CSs[9]);
    temp11 = ReadTemperature(CSs[10]);
    temp12 = ReadTemperature(CSs[11]);
  if(monitorData)  
  {                                                                                                                        
    Serial.print(ttime);
    Serial.print('\t');
